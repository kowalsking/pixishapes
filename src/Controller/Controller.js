  ...
  eventHandlers() {
    ...
    this.view.app.renderer.plugins.interaction.on("pointerdown", e => {
      ...
      if (e.target) {
        ...
        this.view.changeSiblingColour(e.target.type);
        // clicked past the shape
      } else {
        // create a new shape in click coordinates
        this.view.append(createShape(e.data.global.x, e.data.global.y));
      }
    });
